            ...
            <div class="morph-shape" data-morph-open="M260,500H0c0,0,8-120,8-250C8,110,0,0,0,0h260c0,0-8,110-8,250C252,380,260,500,260,500z">
              ...
              <desc>Created with Snap</desc><defs></defs></svg>
                     ...
                     <div id="dd" class="wrapper-dropdown-3" tabindex="1">
                       ...
                       <span class="button" style="box-shadow:none; margin:0px;padding: 0px;"><?php echo trans("Playlists", $bs); ?></span>
                       <div id="dropdownSlider">
                        ...
                        <div id="addNewPlaylist">
                         ...
                         <div class="button" style="padding:4px; height:22;" onclick="appendPlaylists($('#newPlaylistName').val());"><?php echo trans("Add", $bs); ?></div>
                       </div>
                     </div>
                   </div>
                 </div>
              ...
              <div id="artworkButton" class="button buttonPressed" onclick="changeMode('artwork');" ><span><?php echo trans("Artwork", $bs); ?></span></div>
              <div id="youtubeButton" class="button" onclick="changeMode('youtube');" ><span><?php echo trans("Youtube", $bs); ?></span></div>
...
<!--               <div id="Upload" class="button" onclick="pickFlash();"><span>Upload Music</span></div> -->
              <div id="Upload" class="button" onclick="$('#uploadFrameDisplayer').show();"><span><?php echo trans("Upload Music", $bs); ?></span></div>
              <div id="logout" class="button" onclick="logout();" style="border-left: 1px dotted white; "><span><?php echo trans("Logout", $bs); ?></span></div>
       ...
       <!-- </iframe> -->
          ...
          <div id="bgChanger">
             <div id='bgChangerPane'>
               <div>
                 <input id="urlInput" placeholder="<?php echo trans("type URL", $bs); ?>" />
               </div>
               <div id="bgsThumbsContainer">
                 <div>
                   <!-- <img src="/images/bgs/gory.jpg" width="100px" height="100px"> -->
                   <!-- <img src="/images/bgs/gory.jpg" width="100px" height="100px"> -->
                   <!-- <img src="/images/bgs/gory.jpg" width="100px" height="100px"> -->
                   <!-- <img src="/images/bgs/gory.jpg" width="100px" height="100px"> -->
                   <!-- <img src="/images/bgs/gory.jpg" width="100px" height="100px"> -->
             ...
             <div class="button" style="position:absolute; bottom:21%;right:25%;color:white; background:#4da6ff;z-index:1001" onclick='$("#bgChanger").fadeOut();
          ...
          <div id="uploadFrameDisplayer">
             ...
             <div>
             <div style="    position: absolute;     z-index: 50000;     color: black;     margin-left: 27%; bottom: 11%; font-family: myFirstFont;"><input type="checkbox" id="showStatsCheck"> <?php echo trans("Show stats on complete", $bs); ?><br>
             </div>
             <div class="button" style="position:absolute; bottom:11%;right:26.2%;color:white; background:#4da6ff;z-index:1001" onclick='$("#uploadFrameDisplayer").fadeOut();
